/*******************************************************************************
 * ESP32-P4 P486Panel LVGL Calculator
 *
 ...
 * margins and font sizes are all derived from width()/height() at runtime, so
 * the identical ui.cpp lays out a proportionate keypad at any panel size.
 *
