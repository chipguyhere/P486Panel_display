/*
 * ui.cpp - A dark, iOS-styled four-function calculator for the P486 Panel
 *          (720x720 MIPI DSI), written in plain LVGL 9.
 *
 * ---------------------------------------------------------------------------
 * Resolution independence
 * ---------------------------------------------------------------------------
 * Nothing here is pinned to a particular resolution.  build_keypad() reads the
 * live display resolution and derives every dimension from it:
 *
 ...
 *
 * On this 720x720 square panel the four key columns span the full width and the
 * number display takes the generous space above, but the same code lays out a
 * proportionate keypad on a tall, narrow phone-shaped panel without edits: the
 * keys grow or shrink with the width and any extra vertical space simply makes
 * the number display roomier.
 *
